...
export default function ExportModal({
    ...
    const getStatusMessage = () => {
        ...
        if (progress < 60)
            return isPDF ? 'Simulating High-DPI Ink...' : 'Optimizing Pixel Quality...';
        if (progress < 90)
            return isPDF ? 'Calibrating A4 Alignment...' : 'Compressing Images into ZIP...';
                            ...
                            <div className="relative w-24 h-24 sm:w-32 sm:h-32 mb-6 sm:mb-8 flex items-center justify-center z-10">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    {status === 'complete' ? (
                                        ...
                                        <Loader2
                                            size={32}
                                            className="text-neutral-200 animate-spin"
                                        />
                                    )}
                                </div>
                            </div>
