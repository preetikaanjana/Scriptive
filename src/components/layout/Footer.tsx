            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10">
                <div className="grid grid-cols-2 lg:grid-cols-12 gap-10 sm:gap-10 lg:gap-8 mb-12 sm:mb-16">
                    ...
                    <motion.div variants={itemVariants} className="col-span-2 lg:col-span-4">
                        <Link to="/" className="flex items-center gap-3 mb-6 group">
                             <img src={logo} alt="Scriptive" className="w-10 h-10 object-contain group-hover:rotate-12 transition-transform duration-500" />
                             <span className="font-display font-bold text-2xl tracking-tight text-neutral-900">Scriptive.</span>
                        </Link>
                    ...
                    <motion.div variants={itemVariants} className="col-span-1 lg:col-span-2">
                        ...
                        <ul className="space-y-3">
                            <li><a href="https://x.com/preetikaanjana" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-sky-500 transition-colors flex items-center gap-3 text-sm font-bold"><Twitter size={14} /> X (Twitter)</a></li>
                            <li><a href="https://github.com/preetikaanjana" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-purple-600 transition-colors flex items-center gap-3 text-sm font-bold"><Github size={14} /> GitHub</a></li>
                            <li><a href="https://www.linkedin.com/in/preetikaanjana/" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-blue-600 transition-colors flex items-center gap-3 text-sm font-bold"><Linkedin size={14} /> LinkedIn</a></li>
                        </ul>
                    </motion.div>
                </div>
                ...
                <div className="border-t border-black/5 pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <a href="https://github.com/preetikaanjana/Handwritten" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-neutral-900 transition-colors" title="View Source on GitHub">
                            <Github size={14} />
                        </a>
                    </div>
                    <p className="text-xs text-neutral-400 font-bold flex items-center gap-2">
                        Built with <Heart size={12} className="text-rose-500 fill-current" /> by <a href="https://github.com/preetikaanjana" target="_blank" rel="noopener noreferrer" className="text-neutral-900 hover:underline underline-offset-4 font-black">Preetika Anjana</a>
                    </p>
                </div>
            </div>
        </motion.footer>
