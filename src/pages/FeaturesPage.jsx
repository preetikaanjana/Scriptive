        ...
        >
            <div className="space-y-16">
                <section className="prose prose-neutral max-w-none">
                    <p className="lead">
                        Handwritten is more than just a font generator. It's a comprehensive tool
                        designed to mimic the complexity and charm of human penmanship using
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-8 bg-white/50 rounded-3xl border border-black/5 hover:shadow-premium transition-all group">
                        ...
                        <p className="text-neutral-600 leading-relaxed">
                            Our advanced AI analyzes your text and applies natural variations in
                            letter spacing, slant, and baseline drift to simulate the organic feel
                            of real handwriting.
                        </p>
                    </div>
                    ...
                    <div className="p-8 bg-white/50 rounded-3xl border border-black/5 hover:shadow-premium transition-all group">
                        ...
                        <p className="text-neutral-600 leading-relaxed">
                            Choose from a wide range of hand-crafted fonts, or upload your own to
                            create a truly unique signature style for every document.
                        </p>
                    </div>
                    ...
                    <div className="p-8 bg-white/50 rounded-3xl border border-black/5 hover:shadow-premium transition-all group">
                        ...
                        <p className="text-neutral-600 leading-relaxed">
                            Export your creations in high-quality PDF or image formats, ready for
                            printing or digital sharing with zero loss in quality.
                        </p>
                    </div>
                    ...
                    <div className="p-8 bg-white/50 rounded-3xl border border-black/5 hover:shadow-premium transition-all group">
                        ...
                        <p className="text-neutral-600 leading-relaxed">
                            Automatic margin handling, line spacing, and page breaks ensure your
                            letters look professional and perfectly aligned every time.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div>
                            ...
                            <p className="text-neutral-400 max-w-md">
                                Start creating your first handwritten masterpiece today with our
                                intuitive editor.
                            </p>
                        </div>
                        <a
                            href="/"
                            className="px-8 py-4 bg-white text-neutral-900 rounded-2xl font-bold hover:scale-105 transition-transform"
                        >
                            Get Started Free
                        </a>
                    </div>
