...
const updates = [
    {
        ...
        description:
            'A complete visual overhaul introducing a premium atmospheric background with dot grid and mesh gradients, a new high-end 3D depth system, and global animation orchestration.',
        icon: Star,
    ...
    },
    {
        ...
        description:
            'Significant improvements to the AI text humanization engine. Better rhythm, more natural word choice, and improved handwriting flow.',
        icon: Rocket,
    ...
    },
    {
        ...
        description:
            'Reduced load times by 40% and improved canvas rendering performance for smoother export experience.',
        icon: Star,
    ...
    },
    {
        ...
        description:
            'You can now export your handwritten documents directly as multi-page PDF files, processed entirely in your browser.',
        icon: Rocket,
                ...
                {updates.map((update, index) => (
                    <div key={index} className="relative">
                        ...
                        <div className="flex flex-wrap items-center gap-3 mb-4">
                            ...
                            <span
                                className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter ${update.color}`}
                            >
                                {update.type}
                            </span>
