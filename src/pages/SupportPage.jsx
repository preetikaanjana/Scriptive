...
export default function SupportPage() {
    return (
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="p-8 bg-white border border-black/5 rounded-3xl hover:shadow-xl hover:shadow-neutral-900/5 transition-all">
                    ...
                    <p className="text-neutral-500 mb-6">
                        Have a specific question or issue? Send us an email and we'll get back to
                        you within 24 hours.
                    </p>
                    <a
            ...
            <h2 className="text-2xl font-display font-black mb-8 text-center sm:text-left">
                Quick Resources
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <Link
                    to="/faq"
                    className="p-6 bg-white border border-black/5 rounded-2xl hover:border-neutral-900/20 transition-colors flex items-center gap-4 group"
                >
            ...
            <section className="mt-16 p-8 border border-neutral-200 border-dashed rounded-3xl text-center">
                ...
                <p className="text-neutral-500 max-w-lg mx-auto mb-6">
                    We're always looking to improve. If you have an idea for a feature that would
                    make Handwritten better for you, let us know!
                </p>
