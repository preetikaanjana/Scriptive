...
export default function CookiePolicy() {
    return (
        <PageLayout title="Cookie Policy" subtitle="How we use cookies to improve your experience.">
            ...
            <ul>
                <li>
                    <strong>Functionality:</strong> To remember your preferences (like your selected
                    font, ink color, or paper type) so you don't have to reset them every time you
                    visit.
                </li>
                <li>
                    <strong>Analytics:</strong> To understand how visitors interact with our
                    website, helping us improve the user experience.
                </li>
            </ul>
