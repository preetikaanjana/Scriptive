                    ...
                    <motion.div variants={itemVariants} className="relative bg-white rounded-2xl sm:rounded-3xl shadow-premium border border-black/5 p-2 md:p-4 overflow-hidden isolate">
                         ...
                         <div className="w-full bg-[#FAFAFA] rounded-md overflow-hidden relative min-h-[400px] sm:min-h-[500px] flex flex-col md:flex-row">
                                <div className="w-full md:w-1/3 bg-white border-b md:border-b-0 md:border-r border-black/5 p-6 sm:p-8 flex flex-col items-center pt-10 sm:pt-16 md:pt-20">
                                    ...
                                    <img src={photo} alt="Preetika Anjana" className="w-full h-full object-cover rounded-full border-4 border-white shadow-xl relative z-10" />
                                    <div className="absolute bottom-4 right-4 z-20 bg-white p-2 rounded-full shadow-md"><span className="text-2xl">👋</span></div>
                                </div>
                                <h3 className="font-display font-bold text-2xl text-ink mb-1">Preetika Anjana</h3>
                                <p className="text-xs font-black tracking-widest uppercase text-ink/40 mb-8">Developer & Designer</p>
                                <div className="flex gap-4">
                                    <SocialLink href="https://github.com/preetikaanjana" icon={Github} />
                                    <SocialLink href="https://www.linkedin.com/in/preetikaanjana/" icon={Linkedin} />
                                    <SocialLink href="https://x.com/preetikaanjana" icon={Twitter} />
                                    <SocialLink href="mailto:preetikaanjana@gmail.com" icon={Mail} />
                                </div>
                            </div>
                                  ...
                                  <div className="max-w-2xl mx-auto space-y-8">
                                     <motion.div variants={itemVariants} className="bg-white p-8 rounded-3xl shadow-premium border border-black/5">
                                         ...
                                         <p className="text-ink/70 leading-relaxed font-serif text-lg">
                                             I am a developer and designer with a passion for building aesthetic, user-centric interfaces. I love combining modern web technologies with elegant visual design to turn ideas into reality.
                                         </p>
                                     </motion.div>
                                     <motion.div variants={itemVariants} className="bg-white p-8 rounded-3xl shadow-premium border border-black/5">
