...
export default function ContactPage() {
    return (
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 not-prose">
                <div className="bg-white p-8 rounded-2xl border border-neutral-100 shadow-sm text-center">
                    ...
                    <p className="text-neutral-500 mb-6">
                        For general inquiries, bugs, and feature requests.
                    </p>
                    <a
                        href="mailto:arshverma.dev@gmail.com"
                        className="inline-block px-6 py-3 bg-neutral-900 text-white rounded-xl font-bold hover:bg-black transition-colors"
                    >
            ...
            <p>
                Before reaching out, check our <a href="/faq">FAQ page</a> for answers to common
                questions about exports, fonts, and privacy.
            </p>
        </PageLayout>
    );
}
